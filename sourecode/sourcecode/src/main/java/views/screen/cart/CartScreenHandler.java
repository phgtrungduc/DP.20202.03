...
public class CartScreenHandler extends BaseScreenHandler implements Observer {
	...
	void updateCartAmount(){
		...
		labelSubtotal.setText(CommonFunctionCurrency.getCurrencyFormat(subtotal));
		labelVAT.setText(CommonFunctionCurrency.getCurrencyFormat(vat));
		labelAmount.setText(CommonFunctionCurrency.getCurrencyFormat(amount));
	}
