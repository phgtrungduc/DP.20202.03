...
public class InvoiceScreenHandler extends BaseScreenHandler {
	...
	public void setupData(Object dto) throws Exception {
		...
		subtotal.setText(CommonFunctionCurrency.getCurrencyFormat(order.getSubtotal()));
		shippingFees.setText(CommonFunctionCurrency.getCurrencyFormat(order.getShippingFees()));
		total.setText(CommonFunctionCurrency.getCurrencyFormat(order.getTotal()));
